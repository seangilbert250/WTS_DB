...
(
    ...
    CONSTRAINT [FK_Resource_DefaultView_WTS_RESOURCE] FOREIGN KEY ([WTS_RESOURCEID]) REFERENCES [WTS_RESOURCE]([WTS_RESOURCEID]), 
    CONSTRAINT [AK_Resource_DefaultView_Unique] UNIQUE ([WTS_RESOURCEID], [GridNameID], [GridViewID])
) ON [PRIMARY]
