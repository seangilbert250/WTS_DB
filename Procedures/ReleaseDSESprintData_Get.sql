...
/****** Object:  StoredProcedure [dbo].[ReleaseDSESprintData_Get]    Script Date: 6/6/2018 9:53:50 AM ******/
DROP PROCEDURE [dbo].[ReleaseDSESprintData_Get]
GO
...
CREATE PROCEDURE [dbo].[ReleaseDSESprintData_Get]
...
BEGIN
	...
	SELECT @ProductVersionID as ProductVersionID
		,@ReleaseScheduleID as ReleaseScheduleID
		,'Suite' as AORWorkType
		,m.WTS_SYSTEM_SUITE as AORName
		,rs.ReleaseSessionID
		,rs.ReleaseSession
		,rs.StartDate
		,'' as EndDate
	...
	SELECT @ProductVersionID as ProductVersionID
		,@ReleaseScheduleID as ReleaseScheduleID
		,'System' as AORWorkType
		,m.WTS_SYSTEM as AORName
		,rs.ReleaseSessionID
		,rs.ReleaseSession
		,rs.StartDate
		,'' as EndDate
	...
	SELECT @ProductVersionID as ProductVersionID
		,@ReleaseScheduleID as ReleaseScheduleID
		,'Contract' as AORWorkType
		,m.[CONTRACT] as AORName
		,rs.ReleaseSessionID
		,rs.ReleaseSession
		,rs.StartDate
		,'' as EndDate
