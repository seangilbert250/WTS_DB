...
/****** Object:  StoredProcedure [dbo].[AORMeetingInstanceNotesDetail_GetByAgendaKey]    Script Date: 3/16/2018 1:50:02 PM ******/
DROP PROCEDURE [dbo].[AORMeetingInstanceNotesDetail_GetByAgendaKey]
GO
...
CREATE procedure [dbo].[AORMeetingInstanceNotesDetail_GetByAgendaKey]
	@AORMeetingID INT,
	@AORMeetingInstanceID INT,
	@AgendaKey VARCHAR(100)
as
begin
	select 
	...
	where
		...
		and CHARINDEX('<agendaitemkey>' + @AgendaKey + '</agendaitemkey>', amn.ExtData) > 0
end;
GO
